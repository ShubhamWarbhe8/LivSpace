...
<html>
<head>
    <title>LivSpace - AdminLogin</title>
...
<div class="login-container mt-5">
    <h2><i class="fa-solid fa-right-to-bracket me-2"></i>Admin Sign In</h2>
    ...
    <form action="/admin-login" method="post">
        ...
        <button type="submit" class="btn btn-custom">AdminLogin</button>
    </form>

    <div class="signup-link text-center">
        <p>Don't have an account? <a href="/admin-sign-up">Sign Up</a></p>
    </div>
</div>
