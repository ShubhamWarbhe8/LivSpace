...
<html>
<head>
    <title>Add Rent Property Overview</title>
...
<div class="container form-container">
    <h2><i class="fa-solid fa-house-chimney me-2"></i>Add Overview</h2>
    <form method="post" action="${pageContext.request.contextPath}/uploadr" enctype="multipart/form-data">

        <div class="row">
            <div class="col-md-6 mb-3">
                <label>ID</label>
                <input type="text" class="form-control" name="rentPropertyId" required>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control" name="possessionDate" required min="<%= java.time.LocalDate.now() %>" />
            </div>
