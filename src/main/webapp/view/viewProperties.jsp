        ...
        <div class="col-md-10">
            <div class="property-card">
                <div class="property-header">
                    <div>
                        <div class="property-title">Apartment: ${property.apartment}</div>
                        <div class="property-subtitle">Builder: ${property.builder}</div>
                    </div>
                    <div class="text-end">
                        <span class="badge bg-primary">${property.bhk} </span>
                        <span class="badge bg-info text-dark">${property.flatSize} sq ft</span>
                    </div>
                </div>

                <div class="property-details">
                    <p><strong>Price:</strong> ₹${property.price}</p>
                    <p><strong>Possession Date:</strong> ${property.possessionDate}</p>
                    <p><strong>Parking:</strong> ${property.parking}</p>
                    <p><strong>Security:</strong> ${property.security}</p>
                    <p><strong>About:</strong> ${property.aboutProperty}</p>
                </div>

                <div class="card-buttons">
                    <a href="/download-pdf/${property.propertyId}" class="btn btn-download btn-sm">
                        <i class="fa fa-file-pdf"></i> PDF
                    </a>
                    <a href="/appointment/book-appointment/${property.propertyId}" class="btn btn-book btn-sm">
                        <i class="fa fa-calendar-plus"></i> Appointment
                    </a>
                    <a href="${property.map}" class="btn btn-map btn-sm">
